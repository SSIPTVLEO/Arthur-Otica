...
from src.routes.arthurotica import arthurotica_bp
from src.routes.cliente import cliente_bp
from src.routes.ordem_servico import ordem_servico_bp
from src.routes.receita import receita_bp
from src.routes.armacao_lente import armacao_lente_bp

app = Flask(__name__, static_folder=os.path.join(os.path.dirname(__file__), 'static'))
app.config['SECRET_KEY'] = 'asdf#FGSgvasgf$5$WGT'

app.register_blueprint(user_bp, url_prefix='/api')
app.register_blueprint(arthurotica_bp, url_prefix='/api')
app.register_blueprint(cliente_bp, url_prefix='/api')
app.register_blueprint(ordem_servico_bp, url_prefix='/api')
app.register_blueprint(receita_bp, url_prefix='/api')
app.register_blueprint(armacao_lente_bp, url_prefix='/api')
